...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (-.5, -3) {\bt{SELECT} * \bt{FROM} A};
            \node at (.7, -3.5) {\bt{LEFT JOIN} B \bt{ON} A.Key = B.Key};
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \centering
        \begin{tikzpicture}
            \node at (0, 0) {3. RIGHT JOIN (RIGHT OUTER JOIN)};
            \node at (-.5, -3) {\bt{SELECT} * \bt{FROM} A};
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (-.5, -3) {\bt{SELECT} * \bt{FROM} A};
            \node at (.7, -3.5) {\bt{LEFT JOIN} B \bt{ON} A.Key = B.Key \bt{WHERE} B.Key \bt{IS NULL}};
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (-.5, -3) {\bt{SELECT} * \bt{FROM} A};
            \node at (.7, -3.5) {\bt{RIGHT JOIN} B \bt{ON} A.Key = B.Key \bt{WHERE} A.Key \bt{IS NULL}};
    ...
    \begin{minipage}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node at (-.5, -3) {\bt{SELECT} * \bt{FROM} A};
            \node at (.7, -3.5) {\bt{FULL OUTER JOIN} B \bt{ON} A.Key = B.Key};
